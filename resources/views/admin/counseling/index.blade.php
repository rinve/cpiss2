...
<div class="py-12 container">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="row">
            <div class="col-md-12">
                <div class="float-right">{{ $counselings->links() }}</div>
                <div class="card">
                    @if(session('success'))
                    ...
                    @endif
                    <div class="card-header text-center"> All Counseling Messages</div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                        <a href="{{ url('counseling-answer-email/'.$c->id) }}" class="btn btn-info">Send
                                            Mail</a>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        @if($c->status == 0)
                                        <a href="{{ url('counseling/answer/give/'.$c->id) }}"
                                            class="btn btn-success">Answer</a>
                                        @else
                                        <div style="margin-bottom: 10px;">
                                            <a href="{{ url('counseling/answer/edit/'.$c->id) }}"
                                                class="btn btn-warning">Edit</a>
                                        </div>
                                        <a href="{{ url('counseling/delete/'.$c->id) }}"
