...
<div class="py-12 container">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="row">
            <div class="col-md-12">
                <a href="{{ route('hsc.add.info') }}"><button class="btn btn-info" style="margin-bottom: 10px;">Add
                        Information</button></a>
                <div class="float-right">{{ $arts->links() }}</div>
                <div class="card">
                    @if(session('success'))
                    ...
                    @endif
                    <div class="card-header text-center">HSC Arts Information</div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('hsc/info/edit/'.$sc->id) }}" class="btn btn-info">Edit</a>
                                        <a href="{{ url('hsc/info/delete/'.$sc->id) }}"
